 ...
 * @author  user
 */
public class AbstractInit3Page extends javax.swing.JPanel {
    
    /**
     * Creates new form AbstractOfCollectionInitPage
     */
    public AbstractInit3Page() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xComboBox6.setCaption("Collector");
        xComboBox6.setDynamic(true);
        xComboBox6.setExpression("#{name}");
        xComboBox6.setImmediate(true);
        xComboBox6.setItems("collectorList");
        xComboBox6.setName("collector");
