...
public class FAASPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel28.setBounds(10, 83, 96, 18);

        xTextField22.setCaption("Representative");
        xTextField22.setName("faas.info.representativename");
        jPanel7.add(xTextField22);
        xTextField22.setBounds(104, 81, 360, 20);

        jLabel29.setText("Address :");
        jLabel29.setPreferredSize(new java.awt.Dimension(40, 19));
        jPanel7.add(jLabel29);
        jLabel29.setBounds(468, 83, 60, 18);

        xTextField23.setCaption("Owner Address");
        xTextField23.setName("faas.info.representativeaddress");
        jPanel7.add(xTextField23);
        xTextField23.setBounds(528, 81, 266, 20);
        ...
        jPanel3.add(jPanel8);
        jPanel8.setBounds(10, 285, 546, 174);
        ...
        jPanel3.add(jPanel9);
        jPanel9.setBounds(560, 285, 250, 174);
        ...
        jScrollPane1.setBounds(10, 463, 800, 64);
        ...
        formPanel3.setBounds(4, 527, 812, 34);
